package jalandhar.sakshiaggarwal.drumpadapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void playsound1(View v){
        sp.play(sound1,1.01f,1.0f,0,0,10f);
    }
    public void playsound2(View v){
        sp.play(sound2,1.01f,1.0f,0,0,10f);
    }
    public void playsound3(View v){
        sp.play(sound3,1.01f,1.0f,0,0,10f);
    }
    public void playsound4(View v){
        sp.play(sound4,1.01f,1.0f,0,0,10f);
    }
    public void playsound5(View v){
        sp.play(sound5,1.01f,1.0f,0,0,10f);
    }
    public void playsound6(View v){
        sp.play(sound6,1.01f,1.0f,0,0,10f);
    }
    public void playsound7(View v){
        sp.play(sound7,1.01f,1.0f,0,0,10f);
    }
    public void playsound8(View v){
        sp.play(sound8,1.01f,1.0f,0,0,10f);
    }
    public void playsound9(View v){
        sp.play(sound9,1.01f,1.0f,0,0,10f);
    }
}
